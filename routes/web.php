...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('/notification/send-payment-reminder-sms', [NotificationController::class, 'sendPaymentReminderSms']);
    ...
    // Language Word Management Routes
    Route::get('language-words', [LanguageWordController::class, 'index'])->name('language-words.index');
    Route::get('language-words/get-words', [LanguageWordController::class, 'getWords'])->name('language-words.get-words');
    Route::get('language-words/get-module-file-types', [LanguageWordController::class, 'getModuleFileTypes'])->name('language-words.get-module-file-types');
    Route::post('language-words/add-word', [LanguageWordController::class, 'addWord'])->name('language-words.add-word');
    Route::post('language-words/update-word', [LanguageWordController::class, 'updateWord'])->name('language-words.update-word');
    Route::post('language-words/delete-word', [LanguageWordController::class, 'deleteWord'])->name('language-words.delete-word');
    Route::post('language-words/bulk-add-words', [LanguageWordController::class, 'bulkAddWords'])->name('language-words.bulk-add-words');
    ...
    // Clear all caches (app, config, route, view)
