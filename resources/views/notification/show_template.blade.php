...
<div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            <div class="clearfix" style="margin-bottom: 8px;">
                <div class="pull-right">
                    <button type="button" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-accent"
                        id="send_payment_reminder_sms" data-contact-id="{{ $contact->id }}">
                        <i class="fas fa-sms"></i> @lang('lang_v1.payment_reminder') (SMS)
                    </button>
                </div>
            </div>
            <div>
            ...
            <div class="box-group" id="accordion">
                ...
                @if ($notification_template['template_for'] != 'send_ledger')
                    <div class="panel box box-solid">
                        <div class="box-header with-border">
                            <h5 class="box-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#sms_collapse"
    ...
    <script type="text/javascript">
        ...
        // Quick send Payment Reminder SMS from ledger modal
        $(document).on('click', '#send_payment_reminder_sms', function() {
            var contactId = $(this).data('contact-id');
            var btn = $(this);
            btn.text("@lang('lang_v1.sending')...").prop('disabled', true);

            $.ajax({
                method: 'POST',
                url: "{{ url('/notification/send-payment-reminder-sms') }}",
                dataType: 'json',
                data: {
                ...
                complete: function() {
                    btn.text("@lang('lang_v1.payment_reminder') (SMS)").prop('disabled', false);
                }
            });
        });
    </script>
