      ...
      <div class="tw-grid tw-grid-cols-1 tw-gap-4 lg:tw-grid-cols-[minmax(0,1fr)_auto] lg:tw-items-end">
				<div class="tw-flex-1">
					...
					<div class="input-group">
						...
						{!! Form::text('search_product', null, ['class' => 'form-control mousetrap tw-h-12 tw-rounded-r-xl tw-border-slate-200 tw-bg-white tw-text-base tw-shadow-sm focus:tw-border-slate-300 focus:tw-ring-0', 'id' => 'search_product', 'placeholder' => __('lang_v1.search_product_placeholder'), 'autofocus']); !!}
					</div>
				</div>
