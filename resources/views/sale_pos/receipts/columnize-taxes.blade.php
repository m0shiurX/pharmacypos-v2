            ...
            <td>
                ...
                <div class="row invoice-info">
                    ...
                    <div class="col-md-6 invoice-col width-50">
                        ...
                        {{-- Previous Due --}}
                        @php
                            $__prev_due_display = null;
                            if (!empty($receipt_details->all_due) && !empty($receipt_details->total_due)) {
                                $__all_due_num = floatval(
                                    preg_replace('/[^\d\.\-]/', '', (string) $receipt_details->all_due),
                                );
                                $__total_due_num = floatval(
                                    preg_replace('/[^\d\.\-]/', '', (string) $receipt_details->total_due),
                                );
                                $__prev_due_val = $__all_due_num - $__total_due_num;
                                $__prev_due_display =
                                    ($receipt_details->currency['symbol'] ?? '') .
                                    number_format(max($__prev_due_val, 0), 2);
                            }
                        @endphp

                        @if (!empty($__prev_due_display))
                            <div class="bg-light-blue-active text-right font-23 padding-5">
                                <span class="pull-left bg-light-blue-active">
                                    {{ __('Previous Due') }}
                                </span>
                ...
                <div class="row ">
                    <div class="col-xs-12">
                        ...
                        <table class="table table-bordered table-no-top-cell-border table-slim">
                            <thead>
                                <tr style="background-color: #357ca5 !important; color: white !important; font-size: 15px !important font-weight: bold;"
                                    ...
                                    <td style="background-color: #357ca5 !important; color: white !important;"
                                        class="text-left" width="30%">
                                        {!! $receipt_details->table_product_label !!}
                                    </td>

                                    @if ($receipt_details->show_cat_code == 1)
                                        <td style="background-color: #357ca5 !important; color: white !important;"
                                            class="text-right">{!! $receipt_details->cat_code_label !!}</td>
                                    @endif
                                    ...
                                    <td style="background-color: #357ca5 !important; color: white !important;"
                                        class="text-right">
                                        {!! $receipt_details->table_unit_price_label !!} <span class="small color-white">
                                            ({{ $receipt_details->currency['symbol'] }})</span>
                                    </td>
                                    ...
                                    <td style="background-color: #357ca5 !important; color: white !important;"
                                        class="text-right">
                                        Taxable Value <span class="small color-white">
                                            ({{ $receipt_details->currency['symbol'] }})</span>
                                    </td>
                                    ...
                                    @if (!empty($receipt_details->table_tax_headings))
                                        ...
                                        @foreach ($receipt_details->table_tax_headings as $tax_heading)
                                            <td style="background-color: #357ca5 !important; color: white !important;"
                                                ...
                                                {{ $tax_heading }} <span class="small color-white">
                                                    ({{ $receipt_details->currency['symbol'] }})
                                                </span>
                                            </td>
                                    ...
                                    <td style="background-color: #357ca5 !important; color: white !important;"
                                        class="text-right">
                                        {!! $receipt_details->table_subtotal_label !!} <span class="small color-white">
                                            ({{ $receipt_details->currency['symbol'] }})</span>
                                    </td>
                                </tr>
                            </thead>
