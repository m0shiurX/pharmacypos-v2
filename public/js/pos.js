...
$(document).ready(function () {
    ...
    // on change category select2 dropdown
    $(document).on('change', '#product_category', function (e) {
        var selected = $(this).val();
        global_p_category_id = (selected === 'all' || selected === '' || selected === null) ? null : selected;
        $('input#suggestion_page').val(1);
        var location_id = $('input#location_id').val();
        if (location_id != '' || location_id != undefined) {
            get_product_suggestion_list(
    ...
    // on change brand select2 dropdown
    $(document).on('change', '#product_brand', function (e) {
        var selected = $(this).val();
        global_brand_id = (selected === '' || selected === null) ? null : selected;
        $('input#suggestion_page').val(1);
        var location_id = $('input#location_id').val();
